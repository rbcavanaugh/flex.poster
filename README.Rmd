...
Modified version of the postr package from [Oscar de Leon](https://github.com/odeleongt) with changes from [Luke Johnston](https://github.com/lwjohnst86). All credit to these two - this is just modified for my specific needs. Full disclosure: I have no idea what I'm doing. 
...
1. Install the [`rbcavanaugh/flex.poster`](https://github.com/rbcavanaugh/flex.poster) package
  from github `devtools::install_github("rbcavanaugh/flex.poster")`
...
3. Create a new R Markdown document in Rstudio based on the poster template,
  or run `rmarkdown::draft("my_poster.Rmd", template = "poster", package = "flex.poster")`
4. Render the poster as an html file: `rmarkdown::render("my_poster.Rmd")` (or just hit knit in rstudio). set render_print: to false until you're ready to make the poster. 
5. Convert the html file as a printable A1 image: `flex.poster::render_poster_image("my_poster.html")`
